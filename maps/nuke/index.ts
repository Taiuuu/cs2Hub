...
import { tacticPistol1 } from "./strats/pistol";
...
export const nukeData: MapData = {
  ...
  name: "Nuke",
  sideFavor: "CT-sided",
  description: "Nuke es el mapa más favorecedor para la CT del pool. El T debe crear presión vertical para dividir la defensa.",
  philosophy,
  callouts,
  fundamentals,
  tactics: [
